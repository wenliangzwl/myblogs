...
![rabbitmq-概述.png](mq.assets/rabbitmq-概述.png)
...
![rabbitmq-应用解耦-1](mq.assets/rabbitmq-应用解耦-1.png)

![rabbitmq-应用解耦-2](mq.assets/rabbitmq-应用解耦-2.png)

##### 3.2.2 异步提速

![rabbitmq-异步提速-1](mq.assets/rabbitmq-异步提速-1.png)

![rabbitmq-异步提速-2](mq.assets/rabbitmq-异步提速-2.png)

##### 3.2.3 削峰填谷

![rabbitmq-削峰填谷-1](mq.assets/rabbitmq-削峰填谷-1.png)

![rabbitmq-削峰填谷-2](mq.assets/rabbitmq-削峰填谷-2.png)

![rabbitmq-削峰填谷-3](mq.assets/rabbitmq-削峰填谷-3.png)
...
![rabbitmq的优势.png-](mq.assets/rabbitmq的优势.png)
...
### 7. Kafka、RabbitMQ、RocketMQ、消息中间件的对比
